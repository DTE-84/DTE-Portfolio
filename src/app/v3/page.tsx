...
const FlagshipBuilds = () => {
	...
	const builds = [
		...
		{ id: "PCSP", title: "PCSP Assistant Pro", tags: ["Next.js", "Supabase", "HIPAA"], desc: "A HIPAA-compliant compliance documentation tool for state case managers. Features a PostgreSQL star-schema on Supabase for secure data housing, a non-destructive amendment log timeline, dynamic plan depths for waivered vs. non-waivered clients, and automated, audit-ready PDF generation.", link: getAssetPath("case-study-pcsp"), video: "assets/PCSP.mp4" },
